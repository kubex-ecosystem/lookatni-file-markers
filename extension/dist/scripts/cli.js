...
class LookAtniCLI {
    ...
    async handleExtract(args) {
        ...
        const extractor = new extractFiles_1.LookAtniExtractor(options);
    ...
    async handleGenerate(args) {
        ...
        const generator = new generateMarkers_1.LookAtniGenerator(options);
    ...
    async handleTest(args) {
        ...
        const tester = new testLookatni_1.LookAtniTester();
    ...
    async handleDemo(args) {
        ...
        const demo = new demo_1.LookAtniDemo();
        demo.run();
    }
}
exports.LookAtniCLI = LookAtniCLI;
async function main() {
